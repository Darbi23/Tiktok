  ...
  return ( 
    <View style={styles.mainView}>
      <View style={styles.header}>
        <Text style={{ fontSize: 20, fontWeight: 'bold' }}>Welcome {data.fullname}</Text>
      ...
      <Label iconName='instagram' iconType='feather' text={data.instagram ? data.instagram : 'Instagram account'} />
